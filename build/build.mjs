...
const files = [
  ...
  'src/sykabelajar-v2/bootstrap.js','src/sykabelajar-v2/runtime/v2-runtime.js','src/sykabelajar-v2/integration/syka-app-bridge.js','src/sykabelajar-v2/takeover.js','src/sykabelajar-v2/bolt-ui.js','src/sykabelajar-v2/bolt-home.js'
];
...
const manifest = { schema:2, version:'4.15.1-bolt-feed', repo:REPO, base:CDN_BASE, app:appFile, styles:stylesFile, vendor:vendorFile, loader:'loader.js', commit, generatedAt, buildMode:release.mode, missingSourceModules:release.missing };
