...
const manifest = { schema:2, version:'4.18.0-bolt-component-polish', repo:REPO, base:CDN_BASE, app:appFile, styles:stylesFile, vendor:vendorFile, loader:'loader.js', commit, generatedAt, buildMode:release.mode, missingSourceModules:release.missing };
